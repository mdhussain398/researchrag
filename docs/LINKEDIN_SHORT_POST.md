...
Instead of a chat interface, ResearchRAG takes multiple research PDFs and automatically generates structured 13-section literature reviews, 8-dimension comparison matrices, contradiction alerts, and grounded citation verification.
...
🔹 **Provenance**: Automated citation validator verifying document, page, and N-gram overlap (80.5% Grounding Score, 96.9% Precision@K)
